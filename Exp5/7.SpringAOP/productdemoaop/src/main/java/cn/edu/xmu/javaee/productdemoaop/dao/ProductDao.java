...
import cn.edu.xmu.javaee.productdemoaop.repository.SaleRepository;
...
public class ProductDao {
    ...
    @Autowired
    public ProductDao(ProductRepository productRepository, SaleRepository saleRepository, ProductPoMapper productPoMapper, OnSaleDao onSaleDao, ProductAllMapper productAllMapper) {
    ...
    public List<Product> findProductByName_JPA(String name) {
        ...
        ProductAllPo productAllPo = new ProductAllPo(product.getId(),
                        ...
                        product.getSkuSn(),product.getName(), product.getOriginalPrice(), product.getWeight(), product.getBarcode(),
                        product.getUnit(), product.getOriginPlace(), product.getCreatorId(), product.getCreatorName(),
                        product.getModifierId(), product.getModifierName(), product.getGmtCreate(), product.getGmtModified(),
                        product.getCommissionRatio(), product.getFreeThreshold(), product.getStatus()
                );
        List<Product> productList;
